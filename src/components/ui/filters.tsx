/** biome-ignore-all lint/performance/noAccumulatingSpread: Prebuilt component */
/** biome-ignore-all lint/suspicious/noArrayIndexKey: Prebuilt component */
/** biome-ignore-all lint/style/noNonNullAssertion: Prebuilt component */
...
const filterRemoveButtonVariants = cva(
	[
		'inline-flex items-center justify-center transition shrink-0 text-muted-foreground hover:text-foreground'
	],
	{
		variants: {
			variant: {
...
const filterAddButtonVariants = cva(
	[
		'inline-flex items-center justify-center transition shrink-0 text-foreground shadow-xs shadow-black/5',
...
const getOperatorsForField = <T = unknown>(
	...
	return (operators[fieldType] as FilterOperator[]) || operators.select
}
